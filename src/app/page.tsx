...
export default function Page() {
    return (
        <section className="relative container xl:px-16 px-4 py-8">
            <div className="grid lg:grid-cols-[1fr_480px] xl:grid-cols-[1fr_500px] 2xl:grid-cols-[1fr_568px] md:justify-center gap-6 mb-6">
                <div className="bg-backgroundSection rounded-[30px] relative p-8 py-16 sm:px-10 md:max-lg:px-20 md:max-lg:py-24 lg:px-4 lg:py-12 xl:px-16 2xl:pl-16 2xl:pr-[108px] 2xl:py-[98px]">
                    <h1 className="text-[40px] leading-tight font-medium  tracking-[-0.02em] md:text-5xl md:leading-[117%] mb-4 md:mb-6 lg:mb-8 ">
            ...
            <div className="relative">
                ...
                <ul className="grid md:grid-cols-2 xl:grid-cols-4 gap-4 justify-center py-6 md:py-10 w-full text-nowrap cursor-default">
                    <li className="flex gap-4 justify-center items-center ">
                        ...
                        <p className="flex flex-col lg:text-sm leading-[129%] text-xl ">
